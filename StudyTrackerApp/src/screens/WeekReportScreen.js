          ...
          <View style={styles.aiContent}>
            ...
            {aiPlan ? (
              <View style={styles.aiTextCard}>
                ...
                <TouchableOpacity style={styles.copyBtn} onPress={() => Clipboard.setStringAsync(aiPlan)}>
          ...
          <View style={styles.aiContent}>
            ...
            {aiTips ? (
              <View style={styles.aiTextCard}>
                ...
                <TouchableOpacity style={styles.copyBtn} onPress={() => Clipboard.setStringAsync(aiTips)}>
                  <Ionicons name="copy-outline" size={16} color={COLORS.primary} />
                  <Text style={styles.copyBtnText}>Copy</Text>
                </TouchableOpacity>
              </View>
